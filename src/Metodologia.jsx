  ...
  return (
    <div className="metodologia_cont">
      ...
      <div className="metocard_cont">
        <div className="metocard elemento-animado">
          <h5>Solicitud</h5>
          <img src="/meto1.svg" alt="" />
          <h5>1</h5>
        </div>
        <div className="metocard2 elemento-animado">
          <h5>Proyectamos</h5>
          <img src="/meto2.svg" alt="" />
          <h5>2</h5>
        </div>
        <div className="metocard3 elemento-animado">
          <h5>Prototipamos</h5>
          <img src="/meto3.svg" alt="" />
          <h5>3</h5>
        </div>
        <div className="metocard4 elemento-animado">
          <h5>Creamos</h5>
          <img src="/meto4.svg" alt="" />
          <h5>4</h5>
        </div>
        <div className="metocard5 elemento-animado">
          <h5>Pago</h5>
